...
import nl.yasper.neuralib.display.displayable.LayerDisplayable;
import nl.yasper.neuralib.display.displayable.PerceptronDisplayable;
...
public class NetworkPanel extends JPanel implements Runnable, MouseWheelListener {
    ...
    private Runnable mousePressCallback = () -> {};
    ...
    public void setMousePressCallback(Runnable runnable) {
        this.mousePressCallback = runnable;
    }
